...
namespace Prescriptions.Configurations
{
    public class PrescriptionMedicamentEfConfiguration : IEntityTypeConfiguration<PrescriptionMedicament>
    {
        public void Configure(EntityTypeBuilder<PrescriptionMedicament> builder)
        {
                ...
                {
                    new PrescriptionMedicament(){IdMedicament = 1, IdPrescription = 1, Dose = 2, Details = "Nie brać po alkoholu"},
                    new PrescriptionMedicament(){IdMedicament = 2, IdPrescription = 2, Dose = 3, Details = "Brać rano, po obiedzie i wieczorem"},
                    new PrescriptionMedicament(){IdMedicament = 3, IdPrescription = 3, Dose = 1, Details = "Jedna rano"}
                };
