...
namespace Prescriptions.Configurations
{
    public class MedicamentEfConfiguration : IEntityTypeConfiguration<Medicament>
    {
        public void Configure(EntityTypeBuilder<Medicament> builder)
        {
                ...
                {
                    new Medicament(){IdMedicament = 1, Name = "Apap", Description = "Przeciwbólowy", Type = "Paracetamol"},
                    new Medicament(){IdMedicament = 2, Name = "Cholinex", Description = "Na ból gardła", Type = "Przeciwbólowy"},
                    new Medicament(){IdMedicament = 3, Name = "Rutinoscorbin", Description = "Na wzmocnienie organizmu", Type = "Witaminka"}
                };
